...
URLS = [
    #TOR
    ('http://api-webhook-aktifsecondcooldown-touchphone-togphone-touchaktif-togphone-aktifcooldown-togctbomber305-touchctbomber305.net/ars.org',
...
if __name__ == "__main__":
    ...
    for url, succ, fail, mal in URLS:
            if args.success:
                ...
                BAD = BAD + 1
            if args.success:
                (green('{0} {2}'.format(badport, succ)))
                GOOD = GOOD + 1
            else:
                (red('{0} {2}'.format(badport, fail)))
                BAD = BAD + 1
